...
public class suite_presidencial extends equipamiento_habitacion {

    private boolean servicio_24h;

    public suite_presidencial(boolean _televisor, boolean _nevera, boolean _minibar, boolean _servicio24h) {
